...
if(!require("dbscan", quietly=T)) {
  install.packages("dbscan", repos="https://cloud.r-project.org", dependencies=TRUE)
}; library(dbscan)
...
if(!require("nnet", quietly=T)) {
  install.packages("nnet", repos="https://cloud.r-project.org", dependencies=TRUE)
}; library(nnet)
